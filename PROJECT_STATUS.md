...
- Создать GitHub Release `1.0.2`, затем установить ZIP `church-slavonic-translator.zip` на целевом WordPress и проверить настоящий перевод в бесплатном и ключевом режимах.
...
Последний связанный commit: Let theme style translator content.
